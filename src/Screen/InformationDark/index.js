          ...
          {data.map(item =>{
            return(
              <TouchableOpacity onPress={() => onPressItem(item?.id)}style={styles.backgroundVector}>
                ...
                <Image style={styles.iconLy} source={iconLyDark} resizeMode="stretch" />
                <Text style={{marginLeft: 10 , paddingLeft:10, color:'#A09A9A', fontWeight:'700'}} >Unavailable</Text>               
              </TouchableOpacity>
            )
          })}
        </View>
...
export default InformationDark;
